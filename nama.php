...
<html>
    <head>
        <title>Admin - Pencarian Nama</title>
            ...
            <div id="header">
                ...
                <section id="banner">
                    <header>
                        ...
                        <form action="carinamaproses.php" method="POST">
                            <table>
                                <tr><td><input type="text" name="nama" style=" width: 300px;"></td></tr>
                ...
                <!-- Intro -->
                <?php if (isset($_SESSION['id_mhs_1'])) { ?>
                    <?php
                    $id_mhs = $_SESSION['id_mhs_1'];
