            ...
            <div id="header">
                ...
                <section id="banner">
                    <header>
                        ...
                        <form action="carinolokerproses.php" method="POST">
                            <table>
                                <tr><td><input type="text" name="noloker" style=" width: 300px;"></td></tr>
                ...
                <!-- Intro -->
                <?php if (isset($_SESSION['id_mhs_2'])) { ?>
                    <?php
                    $id_mhs = $_SESSION['id_mhs_2'];
